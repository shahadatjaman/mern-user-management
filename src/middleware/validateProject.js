...
const validateProject = [
  ...
  body("color")
    .optional()
    .isLength({ max: 5 })
    .withMessage("Color cannot be longer than 5 characters"),
  ...
  body("team")
    .optional()
    .isArray()
    .withMessage("Team must be an array of users")
    .custom((value) => {
  ...
  body("status")
    ...
    .withMessage("Status must be one of: active, archived, or completed"),
